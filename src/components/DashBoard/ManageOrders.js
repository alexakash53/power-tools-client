...
const ManageOrders = () => {
    ...
    useEffect(() => {
        fetch('https://blooming-thicket-10128.herokuapp.com/all-orders')
            .then(res => res.json())
    ...
    const handleStatus = (id) => {
        fetch(`https://blooming-thicket-10128.herokuapp.com/updateStatus/${id}`, {
            method: 'PUT',
    ...
    const handleStatus1 = (id) => {
        fetch(`https://blooming-thicket-10128.herokuapp.com/updateStatus1/${id}`, {
            method: 'PUT',
            headers: { 'content-type': 'application/json' }
        }).then(res => res.json())
            .then(data => {
